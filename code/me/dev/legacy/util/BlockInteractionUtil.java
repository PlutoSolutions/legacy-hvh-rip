...
public class BlockInteractionUtil {
    public static final List<Block> blackList = Arrays.asList(new Block[]{Blocks.ENDER_CHEST, Blocks.CHEST, Blocks.TRAPPED_CHEST, Blocks.CRAFTING_TABLE, Blocks.ANVIL, Blocks.BREWING_STAND, Blocks.HOPPER, Blocks.DROPPER, Blocks.DISPENSER});
    ...
    public static PlaceResult place(BlockPos pos, float p_Distance, boolean p_Rotate, boolean p_UseSlabRule) {
        ...
        for (EnumFacing side : EnumFacing.values()) {
            ...
            if (blackList.contains((Object)neighborPos) || shulkerList.contains((Object)neighborPos) || activated) {
