...
implements Util {
    ...
    public void loadConfig(String name) {
        List files = Arrays.stream((Object[])Objects.requireNonNull(new File("legacy").listFiles())).filter(File::isDirectory).collect(Collectors.toList());
        this.config = files.contains(new File("legacy/" + name + "/")) ? "legacy/" + name + "/" : "legacy/config/";
