    ...
    public void execute(String[] commands) {
        ...
        if (commands.length == 1) {
            ...
            for (Module.Category category : Client.moduleManager.getCategories()) {
                ...
                for (Module module1 : Client.moduleManager.getModulesByCategory(category)) {
                    modules = modules + (Object)(module1.isEnabled() ? ChatFormatting.GREEN : ChatFormatting.RED) + module1.getName() + (Object)ChatFormatting.WHITE + ", ";
                }
                ModuleCommand.sendMessage(modules);
            }
            return;
