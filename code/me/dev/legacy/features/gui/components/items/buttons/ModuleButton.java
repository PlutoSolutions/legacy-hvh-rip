...
import me.dev.legacy.features.gui.components.items.buttons.BindButton;
import me.dev.legacy.features.gui.components.items.buttons.BooleanButton;
import me.dev.legacy.features.gui.components.items.buttons.Button;
import me.dev.legacy.features.gui.components.items.buttons.EnumButton;
import me.dev.legacy.features.gui.components.items.buttons.Slider;
import me.dev.legacy.features.gui.components.items.buttons.StringButton;
...
extends Button {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        if (!this.items.isEmpty()) {
            if (HUD.getInstance().monkey.getValue().booleanValue()) {
