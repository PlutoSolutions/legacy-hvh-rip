...
extends Button {
    ...
    public void drawScreen(int mouseX, int mouseY, float partialTicks) {
        ...
        Client.textManager.drawStringWithShadow(" - " + this.setting.getName() + " " + (Object)ChatFormatting.GRAY + this.setting.getValue() + (Object)ChatFormatting.WHITE + " +", this.x + 2.3f, this.y - 1.7f - (float)OyVeyGui.getClickGui().getTextOffset(), this.getState() ? -1 : -5592406);
    }
